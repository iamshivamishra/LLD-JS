...
console.log(lot.parkVehicle('KA-01-HH-1234')); // Vehicle KA-01-HH-1234 parked at slot 0
console.log(lot.removeVehicle('KA-01-HH-1234')); // Vehicle KA-01-HH-1234 removed from slot 0
console.log(lot.getAvailableSlots()); // 100  